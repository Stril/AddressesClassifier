...
{
    internal static class DbfService
    {
        /// <summary>
        ...
        /// <returns></returns>
        public static byte GetDbfCodepage(string fileName)
        {
            byte cp = 0;
        ...
        /// <returns></returns>
        private static byte GetByteCodePage(int codePage)
        {
            byte cp = 0;
            switch (codePage)
            {
        ...
        /// <summary>
        /// Установка кодовой страницы файла
        /// </summary>
        /// <param name="fileName">Путь к файлу</param>
        /// <param name="codepage"></param>
        public static void SetDbfCodepage(string fileName, int codepage)
        {
            var cp = GetByteCodePage(codepage);
