...
namespace AddressesClassifierTests.ModelsTests
{
    ...
    public class RegionModelTests
    {
        ...
        [Test]
        [Description("В модели Region было изменено или удалено свойство Code")]
        ...
        [Test]
        [Description("В модели Region было изменено или удалено свойство Name")]
        ...
        [Test]
        [Description("В модели Region было изменено или удалено свойство Contraction")]
        ...
        [Test]
        [Description("В модели Region было изменено или удалено свойство PostIndex")]
        ...
        [Test]
        [Description("В модели Region было изменено или удалено свойство IsFederalCity")]
        public void NamePropertyIsFederalCity_ReturnNotNull()
        {
            var model = _model.GetType().GetProperty("IsFederalCity");
            Assert.NotNull(model);
        }
    }
}
