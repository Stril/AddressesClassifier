...
namespace AddressesClassifierTests.InterfacesTests
{
    ...
    public class InterfaceOleDbReadTests
    {
        ...
        {
            var data = _readerKladr.OleDbReader().ReadRegion("83");
        ...
        {
            var data = _readerKladr.OleDbReader().ReadRegionModel("83");
        ...
        {
            var data = _readerKladr.OleDbReader().ReadRegionModel("99");
        ...
        {
            var data = _readerKladr.OleDbReader().ReadStreetsByRegion("83");
