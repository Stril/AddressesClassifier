...
namespace AddressesClassifierTests.InterfacesTests
{
    ...
    public class InterfaceNdbfReadTests
    {
        ...
        {
            var data = _readerKladr.NdbfReader().ReadRegion("83");
        ...
        {
            var data = _readerKladr.NdbfReader().ReadRegionModel("83");
        ...
        {
            var data = _readerKladr.NdbfReader().ReadRegionModel("99");
        ...
        {
            var data = _readerKladr.NdbfReader().ReadStreetsByRegion("83");
